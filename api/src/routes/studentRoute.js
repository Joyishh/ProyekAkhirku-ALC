...
import { getAllStudents, getStudentDetail, updateStudent, getAvailableStudents } from '../controllers/students.js';
...
router.get('/available', authenticateToken, authUserRole([1, 2]), getAvailableStudents);
