    ...
    <div className="space-y-6">
      <div className="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Pembayaran Bulanan</h1>
            <p className="mt-2 text-gray-600">Kelola tagihan SPP dan riwayat pembayaran.</p>
          </div>
